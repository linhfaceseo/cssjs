...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			if (time.substr(0, 2)=="07")
			{
				$("#myModal").html("<a href='http://faceseo.vn' target='_blank'><img src='http://faceseo.vn/seo/faceseo-la-gi/images/huong-dan-faceseo-1-dang-nhap.png' width='500px'/>Hệ thống SEO</a>. traffic. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
